...
- “있으면 편하겠다”에서 끝내지 않고, 필요하면 직접 만들어 쓰고 다듬는 개발자를 지향합니다.
### Education 📚
...
- 항해99 Java 백엔드 과정 수료(2023.03 ~ 2023.07)
	- 최고 인기 프로젝트 상 수상 : [Commeow](https://github.com/U-Keun/Commeow-BE-streamingserver)
- 한화비전 VEDA(Vision's Edge Device Academy) 임베디드 소프트웨어 교육 수료(2024.07 ~ 2024.12)
	- 최우수 프로젝트 상 수상 : [제스처 기반 사용자 인터페이스 시스템](https://github.com/VEDA-Five-Guys)
### Stack ✏️
