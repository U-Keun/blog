...
## [[Projects/Tickly/Tickly v0.2-0.3  repeat rule & streak\|Tickly v0.2]]  : 반복 규칙 스케줄링
...
## [[Projects/Tickly/Tickly v0.2-0.3  repeat rule & streak\|Tickly v0.3]] : 스트릭 히트맵
### 목표
...
## [[Projects/Tickly/Tickly v0.4 cloud real-time sync\|Tickly v0.4]] : 클라우드 동기화 + 실시간 동기화(0.4.2)
### 목표
