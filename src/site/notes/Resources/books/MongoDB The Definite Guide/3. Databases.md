---
{"sticker":"lucide//file-signature","tags":["DB","MongoDB"],"dg-publish":true,"permalink":"/resources/books/mongo-db-the-definite-guide/3-databases/","dgPassFrontmatter":true,"dg-note-properties":{"sticker":"lucide//file-signature","tags":["DB","MongoDB"]}}
---

MongoDB는 [[Resources/books/MongoDB The Definite Guide/2. Collections\|collection]]을 *database*로 묶어서 관리한다. 하나의 MongoDB 인스턴스는 여러 database를 가질 수 있고, 각각은 여러 개의 collection을 포함한다. 
